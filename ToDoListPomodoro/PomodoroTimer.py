...
class PomodoroTimer:
    ...
    def __init__(self):
        ...
        self.root.config(background='#EA4335')
        self.root.title("Pomodoro Timer")

        self.styl = ttk.Style()
        self.styl.configure("TNotebook.Tab", font=("Ubuntu", 12),background='#EA4335')
        self.styl.configure("TButton", font=("Ubuntu", 12), background='#EA4335')
        ...
        # tworzymy etykiety timerów na środku
        self.pomodoro_timer_label = ttk.Label(self.tab1, text="25:00", font=("Ubuntu", 48))
        # self.pomodoro_timer_label.config(background='#EA4335')
        self.pomodoro_timer_label.pack(pady=40)

        self.short_break_timer_label = ttk.Label(self.tab2, text="05:00", font=("Ubuntu", 48))
        # self.short_break_timer_label.config(background='#EA4335')
        self.short_break_timer_label.pack(pady=40)

        self.long_break_timer_label = ttk.Label(self.tab3, text="15:00", font=("Ubuntu", 48))
        # self.long_break_timer_label.config(background='#EA4335')
        self.long_break_timer_label.pack(pady=40)
        ...
        self.pomodoro_counter_label = ttk.Label(self.grid_layout, text="            Pomodoro counter: 0           ",font=("Ubunut", 16), background='#EA4335')
    ...
    def start_timer(self):
        ...
        if timer_id == 1:
            ...
            if not self.stopped or self.skipped:
                self.pomodoros += 1  # liczymy pomodorro
                self.pomodoro_counter_label.config(text=f"Pomodoro counter: {self.pomodoros}")
                winsound.PlaySound("dzwiek1", winsound.SND_FILENAME)
    ...
    def reset_clock(self):
        ...
        self.pomodoro_counter_label.config(text="Pomodoro counter: 0")
        self.running = False
